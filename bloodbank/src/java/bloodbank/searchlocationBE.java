 ...
 * @author Nithin S R
 */
public class searchlocationBE extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       String loc = request.getParameter("city");
        ...
        String sql = "SELECT * FROM donor WHERE dcity=?";
        ...
        out.println("<table>");
        out.println("<tr><th>Donor ID</th><th>Donor Name</th><th>Donor email</th><th>Date of birth</th><th> Phone number </th><th>Blood group</th><th>Location</th><th>Gender</th></tr>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(searchlocationBE.class.getName()).log(Level.SEVERE, null, ex);
